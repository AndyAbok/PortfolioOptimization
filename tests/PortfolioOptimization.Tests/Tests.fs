...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> PortfolioOptimization.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> PortfolioOptimization.App.configureServices)
